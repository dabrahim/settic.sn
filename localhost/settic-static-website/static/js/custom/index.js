$(document).ready(() => {
    let carouselContainer_div = $('#carousel-container');
    let carouselImagesContainer_div = $('#carousel-images');
    let carouselLayer_div = $('#carousel-layer');
    let carouselImages = $('#carousel-images img');
